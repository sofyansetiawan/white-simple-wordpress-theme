...
add_action('wp_enqueue_scripts', 'eastwood_resources');
...
add_action('after_setup_theme', 'eastwoood_setup');
...
function eastwoood_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'lwp_btn_hover_color_control', array(
		'label' => __('Button Hover Color', 'eastwoood'),
		'section' => 'lwp_standard_colors',
...
add_action('customize_register', 'eastwoood_customize_register');



// Output Customize CSS
function eastwoood_customize_css() { ?>
...
add_action('wp_head', 'eastwoood_customize_css');
